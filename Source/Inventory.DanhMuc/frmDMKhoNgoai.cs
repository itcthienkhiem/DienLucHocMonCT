...
namespace Inventory.DanhMuc
{
    ...
    /// [ ] ?
    /// </summary>
    public partial class frmDMKhoNgoai : Form
    {
        FormActionDelegate frmAction;

        //Data
        clsDMKhoNgoai DM_Kho1;

        //Quản lý Button
        clsPanelButton PanelButton;

        public frmDMKhoNgoai()
        {
            InitializeComponent();
        ...
        public void setFormData()
        {
            ...
            txtTenKho.Text = SelectedRow.Cells["Ten_kho_muon"].Value.ToString();
        }
        ...
        public void LoadData()
        {
            ...
            gridDMKho.DataSource = new clsDMKhoNgoai().GetAllData();
                ...
                case enumButton.Xoa:
                        {
                            ...
                            {
                                Dm_Kho_Muon_Ngoai kho = new Dm_Kho_Muon_Ngoai();
                                kho.ID = DM_Kho1.ID_kho;
                                kho.Ten_kho_muon = DM_Kho1.Ten_kho;
