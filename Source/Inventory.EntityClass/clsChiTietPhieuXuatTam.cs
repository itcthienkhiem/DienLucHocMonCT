   ...
   public  class clsChiTietPhieuXuatTam
    {
       ...
       public int Insert(SQLDAL dal)
       {
           ...
           string sql = "";
           sql += "INSERT INTO Chi_Tiet_Phieu_xuat_tam (ma_phieu_xuat_tam,Ma_vat_tu,So_luong_de_nghi,So_luong_hoan_nhap,So_luong_giu_lai) ";
           sql += "VALUES(@ma_phieu_xuat_tam,@Ma_vat_tu,@So_luong_de_nghi,@So_luong_hoan_nhap,@So_luong_giu_lai)";
       ...
       public int Update(SQLDAL DAL)
       {
           ...
           sql += "Set ma_phieu_xuat_tam=@ma_phieu_xuat_tam,Ma_vat_tu=@Ma_vat_tu,So_luong_de_nghi=@So_luong_de_nghi,So_luong_hoan_nhap=@So_luong_hoan_nhap,So_luong_giu_lai = @So_luong_giu_lai";
