...
namespace Inventory.NhapXuat
{
    ...
    /// [ ] 
    /// </summary>
    public partial class frmHoanNhap : Form
    {
       ...
       // Dictionary<string, clsDMVatTu> Dic = new Dictionary<string, clsDMVatTu>();
        ...
        public frmHoanNhap(enumButton2 stt, string Ma_Phieu_Nhap)
        {
            InitializeComponent();
        ...
        public frmHoanNhap(enumStatus status, clsPhieuNhapKho phieunhap)
        {
            InitializeComponent();
