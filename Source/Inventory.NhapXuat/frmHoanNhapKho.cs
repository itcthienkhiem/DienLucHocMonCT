...
namespace Inventory.NhapXuat
{
    ...
    /// [ ] 
    /// </summary>
    public partial class frmHoanNhapKho : DevExpress.XtraEditors.XtraForm
    {
       ...
       // Dictionary<string, clsDMVatTu> Dic = new Dictionary<string, clsDMVatTu>();
        ...
        public frmHoanNhapKho(enumButton2 stt, string Ma_Phieu_Nhap)
        {
            InitializeComponent();
        ...
        public frmHoanNhapKho(enumStatus status, clsPhieuNhapKho phieunhap)
        {
            InitializeComponent();
