...
namespace Inventory.NhapXuat
{
    ...
    class clsPanelButton2
    {
        ...
        private void btnThem_EnabledChanged(object sender, EventArgs e)
        {
            ...
            if (b.Enabled)
                b.BackgroundImage = global::Inventory.NhapXuat.Properties.Resources.addFile_omc;
            else
                b.BackgroundImage = global::Inventory.NhapXuat.Properties.Resources.addFile_disable;
        }
        ...
        private void btnSua_EnabledChanged(object sender, EventArgs e)
        {
            Button b = sender as Button;
            if (b.Enabled)
                b.BackgroundImage = global::Inventory.NhapXuat.Properties.Resources.edit_gmc;
            else
                b.BackgroundImage = global::Inventory.NhapXuat.Properties.Resources.edit_disable;
        }
        ...
        private void btnLamMoi_EnabledChanged(object sender, EventArgs e)
        {
            Button b = sender as Button;
            if (b.Enabled)
                b.BackgroundImage = global::Inventory.NhapXuat.Properties.Resources.refresh_omc;
            else
                b.BackgroundImage = global::Inventory.NhapXuat.Properties.Resources.refresh_disable;
        }
