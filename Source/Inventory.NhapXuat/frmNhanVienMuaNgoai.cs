...
namespace Inventory.NhapXuat
{
    ...
    /// [ ] 
    /// </summary>
    public partial class frmNhanVienMuaNgoai : Form
    {
       ...
       // Dictionary<string, clsDMVatTu> Dic = new Dictionary<string, clsDMVatTu>();
        ...
        public frmNhanVienMuaNgoai(string no)
        {
            InitializeComponent();
            ...
            if(no.Equals("KCMN"))
            {
                  ...
                  rdoKNTN.Checked = false; rdoNVMN .Checked =false ;
            ...
            if (no.Equals("KCTN"))
            {
                ...
                rdoKNTN.Checked = false; rdoNVMN.Checked = false; clsGiaoDienChung.initCombobox(cbKhoNhan, new clsDM_Kho(), "Ten_kho", "ID_kho", "Ten_kho");
            }
            if (no.Equals("KNMN"))
            {
                isLoaiPhieu = "KNMN";
                ...
                rdoNVMN.Checked = false; clsGiaoDienChung.initCombobox(cbKhoNhan, new clsDM_Kho(), "Ten_kho", "ID_kho", "Ten_kho");
            }
            if (no.Equals("KNTN"))
            {
                isLoaiPhieu = "KNTN";
        ...
        public frmNhanVienMuaNgoai(enumButton2 stt, string Ma_Phieu_Nhap)
        {
            InitializeComponent();
        ...
        public frmNhanVienMuaNgoai(enumButton2 stt, string Ma_Phieu_Nhap,frmDanhSachPhieuNhap pn)
        {
            InitializeComponent();
        ...
        public frmNhanVienMuaNgoai(enumStatus status, clsPhieuNhapKho phieunhap)
        {
            try
            {
                InitializeComponent();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            if (PanelButton.isClickNone())
            {
                ...
                if (rdoNVMN.Checked ==true )
                {
                    txtMaPhieuNhap.Text = RandomMaPhieu("NVMN");
                }
                txtMaPhieuNhap.Enabled = false;
